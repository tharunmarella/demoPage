...
function PlaceholderFrame(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 366 729" aria-hidden="true" {...props}>
      ...
      />
      <rect x="154" y="29" width="56" height="5" rx="2.5" fill="#4B5563" />
    </svg>
  )
}
...
export function PhoneFrame({
  ...
  return (
    <div className={clsx('relative aspect-366/729', className)} {...props}>
      <div className="absolute inset-y-[calc(1/729*100%)] right-[calc(5/729*100%)] left-[calc(7/729*100%)] rounded-[calc(58/366*100%)/calc(58/729*100%)] shadow-2xl bg-gray-800/30" />
      ...
      <PlaceholderFrame className="pointer-events-none absolute inset-0 h-full w-full fill-gray-800" />
      <Image
        src={frame}
        alt=""
